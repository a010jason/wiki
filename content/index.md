...
### 管理 / OKR
- [[concepts/performance-management]] — 績效管理兩大方向：evaluation（KPI）vs development（OKR）
- [[concepts/OKR]] — Intel Andy Grove 起源，O（境界）+ KR（量化）+ 自下而上 + 透明
- [[concepts/KPI]] — Top-down、強調數字成果，環境穩定時有效

### 管理 / 敏捷組織
- [[concepts/agile-organization]] — 21 世紀 VUCA 環境的組織形態，Denning 三大法則
- [[concepts/scrum-method]] — 最普及的 agile method，三角色 + 短週期迭代
- [[concepts/agile-manifesto]] — 2001 軟體開發界源頭宣言，4 條價值觀
- [[concepts/post-bureaucratic-mindset]] — agile 的思維基礎，對照 20 世紀官僚思維

### 管理 / 跨文化
- [[concepts/cross-cultural-management]] — 跨國企業的文化張力（強弱／社會 vs 企業／全球 vs 在地）
- [[concepts/hofstede-cultural-dimensions]] — 6 維度量化文化模型，含台灣分數
- [[concepts/cultural-intelligence-CQ]] — 個人跨文化能力，Uen et al. 對台灣外派研究

### 管理 / 組織行為（OB 基礎）
- [[concepts/organizational-behavior]] — OB 定義 + 3 levels + Integrated Model
- [[concepts/VRIO-framework]] — RBV / 持續競爭優勢檢驗（Valuable/Rare/Inimitable/Organized）
