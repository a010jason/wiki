...
type: entity
domain: mgmt
tags: [entity, hbs-case, hospitality, asset-light, multibusiness, mgmt, strategy]
...
- **30 個品牌** 分四層金字塔：Luxury（Ritz-Carlton, St. Regis, JW, EDITION, Bulgari, W）/ Premium（Marriott, Sheraton, Westin, Le Méridien, Renaissance）/ Select（Courtyard, Fairfield, Residence Inn, SpringHill, Moxy）/ Residences（Homes &amp; Villas）
- **6,000+ 飯店中：旗艦 &lt; 4,000；管理協議 ~1,800；特許經營剩餘** — 美國 80% franchise，海外 28%
- **管理協議**：base management fee ~3% revenue + incentive fee 20-25% profit，期 20-30 年可續至 50 年
- **特許經營**：royalty 4-6% + 行銷費 2-3%
- 2016 營業利潤率約 45%（管理 + 特許部分） — **平台級毛利**

## 90 年歷史關鍵節點

| 年 | 事件 |
|---|---|
| 1927 | J. Willard Marriott Sr 在 Washington DC 開 9 座 Root Beer stand → 改名 Hot Shoppe 速食連鎖 |
| 1937 | 開飛機餐外送（Air Catering）— **多角化的第一步** |
| 1953 | 上市 |
...
- 2017 整合後超過 **1 億會員**（2015 時 5,400 萬）
- **50% 萬豪入住來自會員**
- 預訂通路（2016）：Brand.com 17.68%、Voice 7.33%、Property Direct 31.28%、**OTA 13.33%（自 2014 10.14% 三年連升）**、GDS 9.51%、Group 14.26%
- 教師眉批：「為什麼 loyalty program can't work for Airbnb？→ **沒辦法 linkage 沒辦法槓桿資源（母合優勢）**」 — Bonvoy 的優勢在 **cross-property 母合 linkage**，Airbnb 房東是獨立資源。^[teacher-annotation]

## Compression Night 經濟學
...
> 「Q1. Paradigm shifts / What does the millennials really want? / **Is this new trend a T (threat) or an O (opportunity) to Marriott?** / Does Marriott have a chance in INABC future (de-centralized/digital/network/platform)?」
...
- **MBeta hotel**（北卡 Charlotte）— 客戶共創試房實驗室
- **Element by Marriott**：中型公寓型房間 + 共用廚房 / 餐廳 — 抓住 Airbnb 的「住宅感」需求
- **PlacePass 投資（2017）**：180 國、15 萬種體驗 — 抓住 Airbnb Experiences 的「在地體驗」 趨勢
- **Homes &amp; Villas**：直接做度假屋產品
- **Goji Kitchen + Bar**：彈性場域，2017 亞太 30 家依此重設
- **Coachella 贊助**：贏 SPG Moments 拍賣球員選位 — 走 millennial 體驗行銷路線

## 關鍵角色

- **J. Willard Marriott Sr (1927-)** — 創辦人；Root Beer → Hot Shoppe → 飛機餐 → 飯店
- **Bill Marriott Jr (1964 CEO-)** — 推 brand extension（Courtyard 1983 為起點）；舉債過度被父不悅，但成就 90 年成長
- **Arne Sorenson (2012- CEO)** — 首位非家族 CEO；主導 Starwood 併購；明言「**Airbnb 影響不如預想嚴重，但仍須關注品質、服務與在地**」
- **Stephanie Linnartz**（執行副總 + Global CCO）：「we have to learn from competitors — what do people love about home-sharing?」推 PlacePass / Element / Homes &amp; Villas
- **Ron Harrison**（全球設計官）：MBeta 試房測試（顧客自己創新）
- **Adam Malamut**（首席客戶體驗官）：「成功永遠沒有終點」
- **Karin Timpone**（全球行銷官）：Coachella 贊助
