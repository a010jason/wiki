---
title: Social Science Research — Principles, Methods, and Practices (Bhattacherjee, 2012, 2nd ed., open access)
type: reference
domain: research-methods
tags: [research-methods, textbook, reference, social-science, mgmt]
aliases: [Bhattacherjee SSR, SSR textbook, 社會科學研究法]
sources:
...
Bhattacherjee 的 *Social Science Research: Principles, Methods, and Practices*（USF, 2nd edition, 2012）是一本以 Creative Commons 授權釋出的社會科學研究方法開放教科書（Open Access Textbook, Global Text Project）。全書 15 章，涵蓋從「what is science」到「inferential statistics」的完整研究流程。台灣某 AMBA「管理專題研討」課程以此書為主教材，由教師另製 PPT slides 對應 Ch1-8（前半部基礎），課程主軸是「研究方法論訓練」而非統計實作。

## Why it matters

- **唯一一本開放授權的社會科學研究方法教材**（CC BY-NC-ND），可長期免費引用
- 寫作風格直接、章節短小、定義清楚，**適合做 wiki 主幹索引**（用來校準從其他研究方法書讀到的概念）
- **2012 年寫成，不含 LLM-era 議題**（causal inference / preregistration / replication crisis 處理較淺）— 用來打底，不取代當代方法論討論

## Course context (管理專題研討, AMBA)

| 屬性 | 內容 |
|---|---|
| 主教材 | Bhattacherjee, Social Science Research (open access) |
| 輔助 | 教師 PPT slides Ch1-8 |
| 補充文獻 | 1 篇 conversational AI agents 論文、2 篇氣候風險論文、LIBOR 案例、統計補充 |
| 評分 | Attendance 20% + Final-term presentation/critiques 60% + Final-term report 20% |
| 主軸 | "Rules of the game" + theories + academic writing tips |
| 教師立場 | 東方教育強訓練、弱創造；研究方法是改變思維方式的訓練 |
...
Bhattacherjee 全書 15 章，課程 slides 涵蓋 Ch1-8（基礎 + empirical research 設計）；Ch9-15（data collection + analysis）未在本課程 slides 範圍內，textbook 本身有薄薄一層介紹。

| Bhattacherjee 章節 | 主題 | Textbook 涵蓋 | Lecture slides | Wiki status |
|---|---|---|---|---|
| Ch1 | Science and Scientific Research | pp.5-12 | 128p slides | pending |
| Ch2 | Thinking like a Researcher | pp.13-19 | 133p slides | pending |
| Ch3 | The Research Process | pp.20-27 | 137p slides | pending |
| Ch4 | Theories in Scientific Research | pp.28-37 | 209p slides | pending |
| Ch5 | Research Design | pp.38-44 | 195p slides | pending |
| Ch6 | Measurement of Constructs | pp.45-56 | 182p slides | pending |
| Ch7 | Scale Reliability and Validity | pp.57-66 | 167p slides | pending |
| Ch8 | Sampling | pp.67-74 | 228p slides | pending |
| Ch9 | Survey Research | pp.75-84 | — | textbook only |
| Ch10 | Experimental Research | pp.85-94 | — | textbook only |
| Ch11 | Case Research | pp.95-104 | — | textbook only |
| Ch12 | Interpretive Research | pp.105-113 | — | textbook only |
| Ch13 | Qualitative Analysis | pp.114-118 | — | textbook only |
| Ch14 | Quantitative Analysis: Descriptive | pp.119-126 | — | textbook only |
| Ch15 | Quantitative Analysis: Inferential | pp.127+ | — | textbook only |

## License & citation

Creative Commons Attribution-NonCommercial-NoDerivatives 3.0. Cite as:
> Bhattacherjee, A. (2012). *Social Science Research: Principles, Methods, and Practices* (2nd ed.). University of South Florida, Tampa, FL: Scholar Commons. http://scholarcommons.usf.edu/oa_textbooks/3

## Cross-references

- 課程脈絡見 [[references/management-seminar-2024-yunlin]]（pending Wave 3）
- 與 Colquitt OB Ch1 的 [[concepts/scientific-method-OB]] 對應（同樣論述 induction / deduction / falsifiability，但 OB 教科書視角偏管理應用，Bhattacherjee 視角偏社會科學方法論）

## Provenance

- `extracted`: 0（manifest skeleton，分章 distillation 在子頁面）
- `inferred`: 4（課程主軸 + 教師立場 + Bhattacherjee 適用範圍 + cross-ref to Colquitt — 由教師 slides + 文本立場推得）
- `ambiguous`: 0
