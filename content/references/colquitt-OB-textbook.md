---
title: Organizational Behavior (Colquitt et al., McGraw-Hill 2017)
type: reference
domain: mgmt
tags: [OB, textbook, reference, mgmt]
...
> Colquitt, J. A., LePine, J. A., & Wesson, M. J. (2017). *Organizational Behavior: Improving Performance and Commitment in the Workplace* (5th or 6th ed.). McGraw-Hill Education.

⚠️ 教科書版次與作者基於封面版權（© 2017 McGraw-Hill Education）+ 「Improving the attitudes and behaviors」標準 OB 定義推測，**未 100% 確認版次**。^[ambiguous]

## 課程脈絡

陽明交大 EMBA「管理技能發展專題」課程使用本書作為 OB 章節的教材。^[inferred]

由於 grading 結構（Attendance 60% / Quizzes 25% / Final 15%）與 [[entities/wen-jin-feng]] 教學風格一致，**本 Ch1 PDF 推測來自溫金豐 8/13「組織發展與變革管理」課程**。^[ambiguous] 待確認。
...
Ch1 內案例（Hyundai/Kia 品質逆轉、Nvidia 文化、Wegmans、Google PiLab、Levi's、IKEA、Hilton、Toyota）皆作為「OB practices → firm performance」的證據鏈。^[extracted]
...
### 第一輪（12:33 commit `4d31e72`，雙 subagent 分批 pp.1-84 + pp.85-166）
...
### 第二輪深耕（同日 12:50，8 subagent × 21 頁細分 166 頁）

- [[concepts/task-performance]] — Routine / Adaptive / Creative 三亞型展開；Pulakos 8 維 adaptive + Improv 9-slide 訓練法 + Pixar/Disney 四原則
- [[concepts/organizational-citizenship-behavior]] — OCB 六子向度（Interpersonal: Helping / Courtesy / Sportsmanship + Organizational: Voice / Civic Virtue / Boosterism）+ Citizenship Fatigue + Waldorf Principle
- [[concepts/job-analysis]] — 三步驟方法論 + O*NET 工具
- [[concepts/MBO]] — Drucker / Intel 目標管理 + 與 OKR 的關係（前身脈絡）
- [[concepts/forced-ranking]] — GE 20/70/10 + 衰減曲線（16% → 6% → ≈0%）+ 四大限制

### 案例錨點（166 頁完整覆蓋）

- **Task Performance**：seatbelt 1920 / 全聚德 1864（routine）；JAL 516 / Air France 358 / US Airways 1549 / Starbucks barista note / Ohio 911 dispatcher（adaptive）；Pixar atrium / Southwest humor / 小林眼鏡 × NBA / 3M Post-it / DEWA Afkari 平台 6,235 ideas（creative）
- **OCB**：paper mill 學術起源；Bain / Akamai / Power Home Remodeling Glassdoor；Waldorf "almost 90% true" 故事；30 餐廳 OCB→績效鏈研究
- **CWB**：DiscoVision sabotage；餐飲業 31% / 13% / 12% deviance；office theft $14.6B / year；Mitsubishi $34M 性騷擾和解；Omega Engineering 1996 digital bomb $10M；Symantec IP theft 50% / 40%
- **Performance Management**：Walgreens 五步轉型；American Express behavior=result equal weighting；Netflix Maria + Patty McCord PIP 批判；Tesco 360 在 12 國 / 100 人/週；GE forced ranking 衰減曲線；Accenture performance multiplier / Rypple 社群網絡；GLOBE 跨文化變異
...
- 確切版次與作者 ^[ambiguous]
- 本檔是否為溫金豐 8/13 課程教材 ^[ambiguous]
- 教科書是否有繁中譯本？^[ambiguous]
