...
| Tier 4 — Wave 2 supplementary papers | **6/6 ✅** (human-like-AI-competencies / common-method-bias / instrumental-variable-2SLS / PLS-SEM-vs-CB-SEM / firm-climate-risk / LIBOR) | 0 | 6 |
...
- [x] **`concepts/LIBOR`** — 2026-05-22 done（5 claims: 0 survives / 2 narrow / 2 brittle / **1 unsupported**；single-source PwC consulting firm marketing + academic/regulatory primary sources 系統性缺席；**Hou-Skeie 2014 JFE "LIBOR: Origins, Economics, Crisis, Scandal, and Reform" + Wheatley Review 2012 + FCA Bailey 2017 三大 authoritative 全未引**；AMERIBOR/BSBY/Term SOFR 2021 市場分裂與 RFR adoption heterogeneity 未進入主表格；PwC 8 面向 single consulting firm framework，ARRC playbook + ISDA 2020 IBOR Fallback Protocol industry consensus 未引；**「教師選此篇 6 個理由」是 page 作者 inferred speculation 無 source unsupported**，HBS LIBOR case + Stulz 2010 JACF academic alternative 未提；rollout 用戶質疑「PwC 文宣顧問業利益動機」嫌疑成立）
